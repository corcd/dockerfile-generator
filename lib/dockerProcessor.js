...
function processRun (cmdName, params) {
	let lines = ''
...
function processCmdAndEntryPointAndShell (cmdName, params) {
	if (typeof params === 'string') {
		return `${cmdName} [ "${params}" ]`
	}
...
function processSingleCmd (params) {
	return processCmdAndEntryPointAndShell('CMD', params)
}

function processSingleRun (params) {
	return processRun('RUN', params)
}
...
function processEntryPoint (params) {
	return processCmdAndEntryPointAndShell('ENTRYPOINT', params)
}
...
function processShell (params) {
	return processCmdAndEntryPointAndShell('SHELL', params)
}
